        ...
        <div className="flex items-center gap-2 sm:gap-3 ml-auto shrink-0">
          ...
          <div ref={accountMenuRef} className="relative">
            <button
              ...
              className="w-10 h-10 cursor-pointer rounded-full bg-blue-100 text-blue-700 flex items-center justify-center text-xs font-semibold shadow-sm ring-0 transition hover:bg-blue-900"
            ...
            {accountMenuOpen && (
              <div className="absolute right-0 top-11 z-50 w-56 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl shadow-gray-900/10">
                ...
                <div className="py-1.5">
                  ...
                  <button
                    type="button"
                    className="flex w-full items-center gap-2.5 px-3 py-2 text-left text-blue-500 transition hover:bg-blue-50 cursor-pointer"
                    onClick={() => {
                      setAccountMenuOpen(false)
